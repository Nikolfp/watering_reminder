...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/watering_reminder/](https://nikolfp.github.io/watering_reminder/)
...
* αναζήτηση για **https://github.com/nikolfp/watering_reminder** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/watering_reminder** και κάντε κλικ στην εισαγωγή
